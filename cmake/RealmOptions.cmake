...
# Engine modules (optional, REALM_BUILD_*)
option(REALM_BUILD_RENDER "Build render module (Renderer, ViewportController, LightProbe)" ON)
option(REALM_BUILD_AUDIO "Build audio module (AudioSystem)" ON)
option(REALM_BUILD_CAMERA "Build camera module (Camera components)" ON)
option(REALM_BUILD_PHYSICS "Build physics module (functional/physics)" OFF)
option(REALM_BUILD_ANIMATION "Build animation module (functional/animation)" OFF)
option(REALM_BUILD_PARTICLES "Build particles module" OFF)
option(REALM_BUILD_NETWORK "Build network module (functional/network)" OFF)
