...
class RenderPass {
  public:
    ...
    virtual void render(RHI &rhi, RenderScene &scene,
                        RenderSwapBuffer &resources) = 0;
...
class ShadowPass : public RenderPass {
    ...
    void render(RHI &rhi, RenderScene &scene,
                RenderSwapBuffer &resources) override;
...
class ForwardMainPass : public RenderPass {
  ...
  private:
    void renderSkybox(RHI &rhi, RenderScene &scene,
                      RenderSwapBuffer &resources);
    void renderOpaqueObjects(RHI &rhi, RenderScene &scene,
                             RenderSwapBuffer &resources);
    void renderTransparentObjects(RHI &rhi, RenderScene &scene,
                                  RenderSwapBuffer &resources);
